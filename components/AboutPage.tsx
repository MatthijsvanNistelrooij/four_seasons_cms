            ...
            <div className="container mx-auto px-8 md:px-20 flex flex-col text-white py-20 gap-12">
              ...
              >
                ...
                <p className="md:text-md leading-relaxed">
                  ...
                  ervaring met het knippen, kleuren en stijlen van haar.
                  Daarnaast bieden we ook tal van schoonheidsbehandelingen aan.
                  <br />
                  Wil jij helemaal herboren weer naar buiten lopen? Dan ben je
                  bij ons aan het juiste adres! Kom je snel een keer langs?
                </p>
              </motion.div>
            </div>
          </div>
            ...
            >
              <div className="w-full flex flex-col justify-start">
                ...
                <p className="text-base text-black leading-7">
                  Maak kennis met ons team van kappers, schoonheidsspecialisten
                  en visagisten die voor je klaar staan om je weer te laten
                  stralen. Wij hebben allemaal passie voor het vak en behandelen
                  elke klant als koning(in). Kom je gezellig langs?
                </p>
              </div>
            </motion.div>
          </div>

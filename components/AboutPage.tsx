...
import hero from "../public/assets/hero_12.jpg"
...
export default function AboutPage() {
  ...
  return (
    <main className="">
      <HeaderSection
        hero_image={hero}
        title={`Welkom bij Four Seasons:\nDe kapper in Groningen die weet wat je nodig hebt!`}
        subtitle={`Wij zitten al meer dan 35 jaar in het vak en hebben veel ervaring met het knippen, kleuren en stijlen van haar. Daarnaast bieden we ook tal van schoonheidsbehandelingen aan.\n\nWil jij helemaal herboren weer naar buiten lopen? Dan ben je bij ons aan het juiste adres! Kom je snel een keer langs?`}
      />

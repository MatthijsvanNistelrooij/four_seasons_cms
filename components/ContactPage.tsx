...
const ContactPage = () => {
  ...
  return (
    <>
      <section className="min-h-screen flex flex-col items-center justify-center bg-[#eaeaea] py-10 px-4">
        <h2
          className="lg:text-5xl text-white font-semibold mb-20 text-center max-w-2xl"
        ...
        <div className="container mx-auto px-8 md:px-20 flex justify-center flex-col lg:flex-row gap-5 max-w-4xl">
          ...
          <div className="bg-[#e9207e] text-white p-5 w-1/2 rounded-xl">

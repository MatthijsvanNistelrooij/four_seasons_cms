...
import PhotoCarousel from "./ImageCarousel2"
            ...
            <div className="container mx-auto px-8 md:px-20 flex flex-col py-20 text-white gap-12">
              ...
              >
                ...
                <p className="md:text-md leading-relaxed max-w-6xl">
                  Wij bieden onder andere professionele wimperextensions aan
                  voor wie op zoek is naar vollere en langere wimpers. Onze
                  getrainde wimperstylisten gebruiken alleen hoogwaardige
                  materialen en technieken om ervoor te zorgen dat de extensions
                  op de juiste manier worden geplaatst. Of je nu op zoek bent
                  naar subtiele wimpers of volle wimpers, ons team staat klaar
                  om jou te helpen. Kom langs bij Four Seasons in Groningen en
                  ontdek hoe wij jouw wimpers kunnen laten stralen!
                </p>
                <p className="md:text-md leading-relaxed tracking-wide font-bold">
                  ...
                  sculpturale gezichtsmassage, anti-aging gezichtsmassage,
                  pellen, manicuristische diensten, correctie van nagelcoating,
            ...
            >
              <div className="space-y-6 w-full max-w-xl mr-22">
                ...
                <p className="text-base text-gray-800 leading-7 mb-15">
                  Het gebruik van goede haarproducten is essentieel voor gezond
                  en glanzend haar. Daarom werken wij uitsluitend met
                  hoogwaardige producten van gerenommeerde merken, die
                  zorgvuldig zijn geselecteerd op basis van kwaliteit en
                  effectiviteit. We zijn getraind om te werken met deze
                  producten en kunnen je adviseren over welke producten het
                  beste passen bij jouw haartype en behoeften. Door het gebruik
                  van de juiste producten, kun je niet alleen de gezondheid en
                  glans van je haar verbeteren, maar ook de levensduur van je
